...
body:Column(
  children: [
    ...
    CustomContainer(color:const Color(0xff7D40A2), text: 'Colors',onTap: (){Navigator.pushNamed(context,'/colors');},),
    CustomContainer(color:const Color(0xff51B0D5), text:"Phrases",onTap: (){Navigator.pushNamed(context,'/phrases');},)
